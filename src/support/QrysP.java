...
public class QrysP extends Qrys {
	...
	// party todo list
	public static String GET_PARTY_TODO_LIST = "SELECT t.tid, t.pid, t.title, t.contents, t.duedate, t.status, t.editer_id, p.p_name FROM  todo t JOIN party p ON t.pid = p.pid WHERE t.pid = ? AND status = 'todo01'";
